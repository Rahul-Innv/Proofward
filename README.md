...
| | Family | What it does |
|:-:|:--|:--|
| <img src="assets/marks/choicegate.png" alt="ChoiceGate mark" width="48"> | [**ChoiceGate**](https://gitlab.com/krahul02004/ChoiceGate)<br>[![PyPI version](https://img.shields.io/pypi/v/choicegate)](https://pypi.org/project/choicegate/) | When an agent is about to do a task, ChoiceGate picks the single best capability for it: a skill, a local tool, an MCP server, or an integration. It looks beyond what is already installed; if something materially better exists, it surfaces that as an owner-approved choice, with browser or manual work as the explicit last resort. Deterministic receipts, refusal with a named reason, and it never installs or runs anything itself. |
| <img src="assets/marks/runsteward.png" alt="RunSteward mark" width="48"> | [**RunSteward**](https://gitlab.com/krahul02004/RunSteward)<br>[![pipeline status](https://gitlab.com/krahul02004/RunSteward/badges/main/pipeline.svg)](https://gitlab.com/krahul02004/RunSteward/-/pipelines) | Lets a developer hand an agent work too big for one sitting and walk away: queued tasks with a spending cap, checkpoints, resume after usage-limit resets, and a reviewable morning report. Bundles Claude Carry, the overnight runner. |
| <img src="assets/marks/cairnspan.png" alt="Cairnspan mark" width="48"> | [**Cairnspan**](https://gitlab.com/krahul02004/Cairnspan)<br>[![pipeline status](https://gitlab.com/krahul02004/Cairnspan/badges/main/pipeline.svg)](https://gitlab.com/krahul02004/Cairnspan/-/pipelines) | Lets one local coding agent hand a bounded task to another (Claude Code and Codex, each through its own logged-in client, no shared keys), with fail-closed launchers and a receipt for every run. |
