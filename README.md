...
| <img src="assets/marks/runsteward.png" alt="RunSteward mark" width="48"> | [**RunSteward**](https://gitlab.com/krahul02004/RunSteward)<br>[![RunSteward pipeline status](https://gitlab.com/krahul02004/RunSteward/badges/main/pipeline.svg)](https://gitlab.com/krahul02004/RunSteward/-/pipelines) | Lets a developer hand an agent work too big for one sitting and walk away: queued tasks with a spending cap, checkpoints, resume after usage-limit resets, and a reviewable morning report. Bundles Claude Carry, the overnight runner. |
| <img src="assets/marks/cairnspan.png" alt="Cairnspan mark" width="48"> | [**Cairnspan**](https://gitlab.com/krahul02004/Cairnspan)<br>[![Cairnspan pipeline status](https://gitlab.com/krahul02004/Cairnspan/badges/main/pipeline.svg)](https://gitlab.com/krahul02004/Cairnspan/-/pipelines) | Lets one local coding agent hand a bounded task to another (Claude Code and Codex, each through its own logged-in client, no shared keys), with fail-closed launchers and a receipt for every run. |
